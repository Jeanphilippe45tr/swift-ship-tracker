...
const partners = [
  ...
  { name: 'Hapag-Lloyd', color: '#FF6B00' },
  { name: 'CMA CGM', color: '#003B71' },
];
    ...
    <div className="container mx-auto px-4">
      ...
      <div className="flex flex-wrap items-center justify-center gap-6 md:gap-10">
        {partners.map(p => (
          <div
            key={p.name}
            className="flex items-center justify-center px-5 py-2.5 rounded-lg bg-card shadow-sm border border-border hover:shadow-card transition-shadow"
          >
